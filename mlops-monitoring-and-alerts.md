...
2. **\(good\)** [**Inferring Concept Drift Without Labeled Data**](https://concept-drift.fastforwardlabs.com/)**. talks about stream-based drift by Cloudera - fast forward labs.**
3. **Arize.ai** 
